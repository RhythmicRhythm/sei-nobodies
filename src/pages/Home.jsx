  ...
  return (
    <div>
     ...
     <div className="mx-auto flex max-w-[500px] justify-center items-center px-6">
      ...
      <h1 className='text-[60px] sm:text-[100px] text-white'>
      NOBODIES
      </h1>
            ...
            <form className="mt-8 text-white w-full px-8">
              <div className="flex flex-col text-left mb-6">
                <label className="w-full mb-2 text-lg">
                  Twitter Username <span className="text-orange-400 text-xs mb-3"> 
                  *(disabled)</span>
                </label>
                <input 
                type="text" 
              ...
              <div className="flex flex-col text-left mb-6">
                <label className="w-full mb-2 text-lg">
                  Discord Username <span className="text-orange-400 text-sm mb-3"> 
                  * (required)</span>
                </label>
                <input 
                type="text" 
              ...
              <div className="flex flex-col text-left mb-6">
                <label className="w-full mb-2 text-lg">
                  Input Sei Address - <span className="text-orange-400 text-sm mb-3"> 
                  * (required)</span>
                </label>
                <input 
                type="text" 
              ...
              <div className="flex flex-col text-left mb-6">
                <label className="w-full mb-2 text-lg">
                What interests you the most about Nobodies community ?  <span className="text-orange-400 text-sm mb-3"> 
                  * (required)</span>
                </label>
                <textarea 
                type="text" 
              ...
              <div className="flex flex-col text-left mb-6">
                <label className="w-full mb-2 text-lg">
                Is this going to be your first Sei presale ? If Yes kindly share your previous experiences.   <span className="text-orange-400 text-sm mb-3"> 
                  * (required)</span>
                </label>
                <textarea 
                type="text" 
