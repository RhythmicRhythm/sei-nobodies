        ...
        <div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
          ...
          <div className="flex flex-wrap ">
            ...
            <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
              ...
              <a href="#" className="px-4 py-3 text-blue-700 transition-all transform border border-blue-500 hover:bg-blue-600 dark:border-blue-400 dark:hover:bg-blue-500 dark:hover:text-gray-100 dark:hover:border-blue-500 dark:text-blue-400 hover:text-gray-100">
                Discover more
              </a>
            </div>
          </div>
